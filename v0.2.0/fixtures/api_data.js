define({ "api": [
  {
    ...
    "group": "Define",
    "version": "0.8.0",
    "description": "Example of @apiDefine and @apiUse",
    "parameter": {
      "fields": {
        "Parameter": [
          {
  ...
  },
  {
    ...
    "group": "Example",
    "version": "0.7.1",
    "description": "Extended usage of @apiExample with different example types.",
    "examples": [
      {
  ...
  },
  {
    ...
    "groupDescription": "This is a Group Description. It is <strong>Markdown</strong> capable.",
    "sampleRequest": [
      {
        ...
        "400": [
          {
            ...
            "optional": false,
            "field": "error2",
            "description": "Undefined Group &quot;400&quot;"
          }
        ],
  ...
  },
  {
    ...
    "group": "Language",
    "version": "0.4.0",
    "description": "Test for Clojure Comment-Syntax.",
  ...
  },
  {
    ...
    "group": "Markdown",
    "version": "0.6.0",
    "description": "Enable markdown for all description fields.</p> <p>This <strong>text</strong> is in a <strong>separate</strong> p.</p> <ul> <li>List 1</li> <li>List 2</li> </ul> <p>Multiline markdown text, output in one line.",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "param1",
            "description": "This is a markdown <strong>apiParam</strong></p> <p>Separate line."
          }
        ]
      }
    },
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "param1",
            "description": "Parameter and description."
          },
          {
            "group": "Parameter",
            "optional": false,
          ...
          },
          {
            ...
            "field": "param3",
            "defaultValue": "Default Value",
            "description": "Parameter, default value and description."
          },
          {
            "group": "Parameter",
            "optional": false,
          ...
          },
          {
            ...
            "optional": true,
            "field": "param5",
            "description": "Optional parameter and description."
          },
          {
            "group": "Parameter",
            "optional": true,
          ...
          },
          {
            ...
            "field": "param7",
            "defaultValue": "Default Value",
            "description": "Optional parameter, default value and description."
          },
          {
            "group": "Parameter",
            "optional": true,
          ...
          },
          {
            ...
            "optional": false,
            "field": "param9",
            "description": "Type, parameter and description."
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "field": "param11",
            "defaultValue": "Default Value",
            "description": "Type, parameter and default value."
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": true,
            "field": "param13",
            "description": "Type, optional parameter and description."
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "field": "param15",
            "defaultValue": "Default Value",
            "description": "Type, optional parameter, default value and description."
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "param17",
            "description": "Type, size, parameter and description."
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "field": "param19",
            "defaultValue": "Default Value",
            "description": "Type, size, parameter, default value and description."
          },
          {
            "group": "Parameter",
            "type": "Number",
          ...
          },
          {
            ...
            "optional": false,
            "field": "param21",
            "description": "Type, parameter and allowed string value."
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "optional": false,
            "field": "param22",
            "description": "Type, parameter and allowed list of string values."
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": false,
            "field": "param23",
            "description": "Type, parameter and allowed value."
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": false,
            "field": "param24",
            "description": "Type, parameter and allowed list of values."
          },
          {
            "group": "Parameter",
            "type": "String",
            ...
            "optional": false,
            "field": "param25",
            "description": "Type, size, parameter and allowed string value."
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": false,
            "field": "param27",
            "description": "Type, size, parameter and allowed value."
          },
          {
            "group": "Parameter",
            "type": "Number",
            ...
            "optional": false,
            "field": "param28",
            "description": "Type, size, parameter and allowed list of values."
          },
          {
            "group": "Parameter",
            ...
            "optional": false,
            "field": "param29",
            "description": "Type with markdown link."
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "group": "Param",
    "version": "0.8.0",
    "description": "Usage of @apiParamExample.",
    "examples": [
      {
  ...
  },
  {
    ...
    "group": "Param",
    "version": "0.1.0",
    "description": "Returned success parameters. Syntax is the same as for @apiParam",
    "error": {
      "fields": {
        "Error 4xx": [
          {
  ...
  },
  {
    ...
    "group": "Permission",
    "version": "0.8.0",
    "description": "@apiPermission test.",
    "permission": [
      {
  ...
  },
  {
    ...
    "group": "indent",
    "description": "Text line 1 (Begin: 4xSpaces (3 removed)). Text line 2 (Begin: 3xSpaces (3 removed), End: 2xSpaces).",
    "version": "0.0.0",
  ...
  },
  {
    ...
    "group": "indent",
    "description": "Text line 1 (Begin: 3xTab (2 removed)). Text line 2 (Begin: 2x Tab (2 removed), End: 1xTab).",
    "version": "0.0.0",
    "filename": "src/indent.js",
    "groupTitle": "Indent",
  ...
  },
  {
    ...
    "group": "indent",
    "description": "Text line 1 (Begin: 1xTab, 2xSpaces). Text line 2 (Begin: 3xSpaces, End: 1xTab).",
    "version": "0.0.0",
    "filename": "src/indent.js",
    "groupTitle": "Indent",
